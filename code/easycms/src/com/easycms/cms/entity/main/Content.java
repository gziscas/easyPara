...
import com.easycms.cms.entity.main.base.BaseContent;
import com.easycms.cms.staticpage.StaticPageUtils;
...
import com.easycms.core.web.ContentInterface;
...
//			return getUrlDynamic(null);
	...
	public JSONObject convertToJson(Integer format,Integer https,boolean hasCollect) 
		...
		json.put("id", getId());
		String urlPrefix="";
		if(https==com.easycms.cms.api.Constants.URL_HTTP){
			json.put("url", getUrl());
	 ...
	 */
	public Content(java.lang.Integer id,
                   com.easycms.core.entity.CmsSite site, java.util.Date sortDate,
