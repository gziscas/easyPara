package com.easycms.cms.entity.main.base;
...
public abstract class BaseContent  implements Serializable {
	...
	// one to one
	private com.easycms.cms.entity.main.ContentExt contentExt;
	private com.easycms.cms.entity.main.ContentCount contentCount;

	// many to one
	private com.easycms.cms.entity.main.ContentType type;
	private com.easycms.core.entity.CmsSite site;
	private com.easycms.core.entity.CmsUser user;
	private com.easycms.cms.entity.main.Channel channel;
	private com.easycms.cms.entity.main.CmsModel model;

	// collections
	private java.util.Set<com.easycms.cms.entity.main.Channel> channels;
	private java.util.Set<com.easycms.cms.entity.main.CmsTopic> topics;
	private java.util.Set<com.easycms.core.entity.CmsGroup> viewGroups;
	private java.util.List<com.easycms.cms.entity.main.ContentTag> tags;
	private java.util.List<com.easycms.cms.entity.main.ContentPicture> pictures;
	private java.util.List<com.easycms.cms.entity.main.ContentAttachment> attachments;
	private java.util.Set<com.easycms.cms.entity.main.ContentTxt> contentTxtSet;
	private java.util.Set<com.easycms.cms.entity.main.ContentCheck> contentCheckSet;
	private java.util.Set<com.easycms.cms.entity.main.ContentCharge> contentChargeSet;
	private java.util.Set<com.easycms.cms.entity.main.ContentBuy> contentBuySet;
	private java.util.Map<java.lang.String, java.lang.String> attr;
	private java.util.Set<com.easycms.core.entity.CmsUser> collectUsers;
	private java.util.Set<com.easycms.cms.entity.assist.CmsComment> comments;
	private java.util.Set<com.easycms.cms.entity.assist.CmsFile> files;
	private java.util.Set<com.easycms.cms.entity.assist.CmsJobApply> jobApplys;
	private java.util.Set<com.easycms.cms.entity.assist.CmsScoreRecord> scoreRecordSet;
	private java.util.Set<com.easycms.cms.entity.main.ContentRecord> contentRecordSet;
	private java.util.List<com.easycms.cms.entity.main.ContentRewardFix> rewardFixs;
	...
	public java.util.Set<com.easycms.cms.entity.assist.CmsFile> getFiles() {
		return files;
	}

	public void setFiles(java.util.Set<com.easycms.cms.entity.assist.CmsFile> files) {
		this.files = files;
	}
	
	public java.util.Set<com.easycms.cms.entity.assist.CmsJobApply> getJobApplys() {
			return jobApplys;
	}
	
	public void setJobApplys(
				java.util.Set<com.easycms.cms.entity.assist.CmsJobApply> jobApplys) {
	...
	public java.util.Set<com.easycms.cms.entity.assist.CmsScoreRecord> getScoreRecordSet() {
		return scoreRecordSet;
	}

	public void setScoreRecordSet(
			java.util.Set<com.easycms.cms.entity.assist.CmsScoreRecord> scoreRecordSet) {
		this.scoreRecordSet = scoreRecordSet;
	}
	

	public java.util.Set<com.easycms.cms.entity.main.ContentRecord> getContentRecordSet() {
		return contentRecordSet;
	}

	public void setContentRecordSet(java.util.Set<com.easycms.cms.entity.main.ContentRecord> contentRecordSet) {
		this.contentRecordSet = contentRecordSet;
	}

	public java.util.List<com.easycms.cms.entity.main.ContentRewardFix> getRewardFixs() {
		return rewardFixs;
	}

	public void setRewardFixs(java.util.List<com.easycms.cms.entity.main.ContentRewardFix> rewardFixs) {
	 ...
	 */
	public com.easycms.cms.entity.main.ContentExt getContentExt () {
		return contentExt;
	}
	 ...
	 */
	public void setContentExt (com.easycms.cms.entity.main.ContentExt contentExt) {
	 ...
	 */
	public com.easycms.cms.entity.main.ContentCount getContentCount () {
		return contentCount;
	}
	 ...
	 */
	public void setContentCount (com.easycms.cms.entity.main.ContentCount contentCount) {
	 ...
	 */
	public com.easycms.cms.entity.main.ContentType getType () {
		return type;
	}
	 ...
	 */
	public void setType (com.easycms.cms.entity.main.ContentType type) {
		this.type = type;
	}
	 ...
	 */
	public com.easycms.core.entity.CmsSite getSite () {
		return site;
	}
	 ...
	 */
	public void setSite (com.easycms.core.entity.CmsSite site) {
		this.site = site;
	}
	 ...
	 */
	public com.easycms.core.entity.CmsUser getUser () {
		return user;
	}
	 ...
	 */
	public void setUser (com.easycms.core.entity.CmsUser user) {
		this.user = user;
	}
	 ...
	 */
	public com.easycms.cms.entity.main.Channel getChannel () {
		return channel;
	}
	 ...
	 */
	public void setChannel (com.easycms.cms.entity.main.Channel channel) {
		this.channel = channel;
	}
	
	public com.easycms.cms.entity.main.CmsModel getModel() {
		return model;
	}

	public void setModel(com.easycms.cms.entity.main.CmsModel model) {
		this.model = model;
	}
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.main.Channel> getChannels () {
		return channels;
	}
	 ...
	 */
	public void setChannels (java.util.Set<com.easycms.cms.entity.main.Channel> channels) {
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.main.CmsTopic> getTopics () {
		return topics;
	}
	 ...
	 */
	public void setTopics (java.util.Set<com.easycms.cms.entity.main.CmsTopic> topics) {
		this.topics = topics;
	}
	 ...
	 */
	public java.util.Set<com.easycms.core.entity.CmsGroup> getViewGroups () {
		return viewGroups;
	}
	 ...
	 */
	public void setViewGroups (java.util.Set<com.easycms.core.entity.CmsGroup> viewGroups) {
	 ...
	 */
	public java.util.List<com.easycms.cms.entity.main.ContentTag> getTags () {
		return tags;
	}
	 ...
	 */
	public void setTags (java.util.List<com.easycms.cms.entity.main.ContentTag> tags) {
		this.tags = tags;
	}
	 ...
	 */
	public java.util.List<com.easycms.cms.entity.main.ContentPicture> getPictures () {
		return pictures;
	}
	 ...
	 */
	public void setPictures (java.util.List<com.easycms.cms.entity.main.ContentPicture> pictures) {
	 ...
	 */
	public java.util.List<com.easycms.cms.entity.main.ContentAttachment> getAttachments () {
		return attachments;
	}
	 ...
	 */
	public void setAttachments (java.util.List<com.easycms.cms.entity.main.ContentAttachment> attachments) {
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.main.ContentTxt> getContentTxtSet () {
	 ...
	 */
	public void setContentTxtSet (java.util.Set<com.easycms.cms.entity.main.ContentTxt> contentTxtSet) {
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.main.ContentCheck> getContentCheckSet () {
	 ...
	 */
	public void setContentCheckSet (java.util.Set<com.easycms.cms.entity.main.ContentCheck> contentCheckSet) {
		this.contentCheckSet = contentCheckSet;
	}
	
	public java.util.Set<com.easycms.cms.entity.main.ContentCharge> getContentChargeSet() {
		return contentChargeSet;
	}

	public void setContentChargeSet(java.util.Set<com.easycms.cms.entity.main.ContentCharge> contentChargeSet) {
		this.contentChargeSet = contentChargeSet;
	}

	public java.util.Set<com.easycms.cms.entity.main.ContentBuy> getContentBuySet() {
		return contentBuySet;
	}

	public void setContentBuySet(java.util.Set<com.easycms.cms.entity.main.ContentBuy> contentBuySet) {
	...
	public java.util.Set<com.easycms.core.entity.CmsUser> getCollectUsers() {
		return collectUsers;
	}

	public void setCollectUsers(
			java.util.Set<com.easycms.core.entity.CmsUser> collectUsers) {
		this.collectUsers = collectUsers;
	}
	

	public java.util.Set<com.easycms.cms.entity.assist.CmsComment> getComments() {
		return comments;
	}

	public void setComments(
			java.util.Set<com.easycms.cms.entity.assist.CmsComment> comments) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.easycms.cms.entity.main.Content)) return false;
		else {
			com.easycms.cms.entity.main.Content content = (com.easycms.cms.entity.main.Content) obj;
