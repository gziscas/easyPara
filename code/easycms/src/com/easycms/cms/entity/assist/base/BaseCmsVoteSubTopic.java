...
public abstract class BaseCmsVoteSubTopic  implements Serializable {
	...
	public BaseCmsVoteSubTopic (
		...
		com.easycms.cms.entity.assist.CmsVoteTopic voteTopic,
	...
	// many to one
	private com.easycms.cms.entity.assist.CmsVoteTopic voteTopic;

	// collections
	private java.util.Set<com.easycms.cms.entity.assist.CmsVoteItem> voteItems;
	private java.util.Set<com.easycms.cms.entity.assist.CmsVoteReply> voteReplys;
	 ...
	 */
	public com.easycms.cms.entity.assist.CmsVoteTopic getVoteTopic () {
		return voteTopic;
	}
	 ...
	 */
	public void setVoteTopic (com.easycms.cms.entity.assist.CmsVoteTopic voteTopic) {
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.assist.CmsVoteItem> getVoteItems () {
		return voteItems;
	}
	 ...
	 */
	public void setVoteItems (java.util.Set<com.easycms.cms.entity.assist.CmsVoteItem> voteItems) {
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.assist.CmsVoteReply> getVoteReplys () {
		return voteReplys;
	}
	 ...
	 */
	public void setVoteReplys (java.util.Set<com.easycms.cms.entity.assist.CmsVoteReply> voteReplys) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.easycms.cms.entity.assist.CmsVoteSubTopic)) return false;
		else {
			com.easycms.cms.entity.assist.CmsVoteSubTopic cmsVoteSubTopic = (com.easycms.cms.entity.assist.CmsVoteSubTopic) obj;
