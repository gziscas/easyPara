...
public abstract class BaseCmsVoteTopic  implements Serializable {
	...
	private java.lang.Boolean limitWeiXin;
	private java.lang.Integer voteDay;

	// many to one
	private com.easycms.core.entity.CmsSite site;

	// collections
	private java.util.Set<com.easycms.cms.entity.assist.CmsVoteItem> items;
	private java.util.Set<com.easycms.cms.entity.assist.CmsVoteSubTopic> subtopics;
	private java.util.Set<com.easycms.cms.entity.assist.CmsVoteRecord> records;
	...
	public java.lang.Boolean getLimitWeiXin() {
		return limitWeiXin;
	}

	public void setLimitWeiXin(java.lang.Boolean limitWeiXin) {
		this.limitWeiXin = limitWeiXin;
	}

	public java.lang.Integer getVoteDay() {
		return voteDay;
	}

	public void setVoteDay(java.lang.Integer voteDay) {
	 ...
	 */
	public java.util.Set<com.easycms.cms.entity.assist.CmsVoteItem> getItems () {
		return items;
	}
	 ...
	 */
	public void setItems (java.util.Set<com.easycms.cms.entity.assist.CmsVoteItem> items) {
		this.items = items;
	}

	public java.util.Set<com.easycms.cms.entity.assist.CmsVoteSubTopic> getSubtopics() {
		return subtopics;
	}

	public void setSubtopics(
			java.util.Set<com.easycms.cms.entity.assist.CmsVoteSubTopic> subtopics) {
		this.subtopics = subtopics;
	}

	public java.util.Set<com.easycms.cms.entity.assist.CmsVoteRecord> getRecords() {
		return records;
	}

	public void setRecords(
			java.util.Set<com.easycms.cms.entity.assist.CmsVoteRecord> records) {
		this.records = records;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.easycms.cms.entity.assist.CmsVoteTopic)) return false;
		else {
			com.easycms.cms.entity.assist.CmsVoteTopic cmsVoteTopic = (com.easycms.cms.entity.assist.CmsVoteTopic) obj;
