...
public abstract class BaseCmsGuestbook  implements Serializable {
	...
	public BaseCmsGuestbook (
		...
		com.easycms.cms.entity.assist.CmsGuestbookCtg ctg,
		java.lang.String ip,
	...
	// one to one
	private com.easycms.cms.entity.assist.CmsGuestbookExt ext;

	// many to one
	private com.easycms.core.entity.CmsUser member;
	private com.easycms.core.entity.CmsUser admin;
	private com.easycms.core.entity.CmsSite site;
	private com.easycms.cms.entity.assist.CmsGuestbookCtg ctg;
	 ...
	 */
	public com.easycms.cms.entity.assist.CmsGuestbookExt getExt () {
		return ext;
	}
	 ...
	 */
	public void setExt (com.easycms.cms.entity.assist.CmsGuestbookExt ext) {
		this.ext = ext;
	}
	 ...
	 */
	public com.easycms.core.entity.CmsUser getMember () {
		return member;
	}
	 ...
	 */
	public void setMember (com.easycms.core.entity.CmsUser member) {
		this.member = member;
	}
	 ...
	 */
	public com.easycms.core.entity.CmsUser getAdmin () {
		return admin;
	}
	 ...
	 */
	public void setAdmin (com.easycms.core.entity.CmsUser admin) {
		this.admin = admin;
	}
	 ...
	 */
	public com.easycms.cms.entity.assist.CmsGuestbookCtg getCtg () {
		return ctg;
	}
	 ...
	 */
	public void setCtg (com.easycms.cms.entity.assist.CmsGuestbookCtg ctg) {
		this.ctg = ctg;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.easycms.cms.entity.assist.CmsGuestbook)) return false;
		else {
			com.easycms.cms.entity.assist.CmsGuestbook cmsGuestbook = (com.easycms.cms.entity.assist.CmsGuestbook) obj;
