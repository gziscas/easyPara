...
public abstract class BaseCmsVoteItem  implements Serializable {
	...
	public BaseCmsVoteItem (
		...
		com.easycms.cms.entity.assist.CmsVoteTopic topic,
	...
	// many to one
	private com.easycms.cms.entity.assist.CmsVoteTopic topic;
	private com.easycms.cms.entity.assist.CmsVoteSubTopic subTopic;
	 ...
	 */
	public com.easycms.cms.entity.assist.CmsVoteTopic getTopic () {
		return topic;
	}
	 ...
	 */
	public void setTopic (com.easycms.cms.entity.assist.CmsVoteTopic topic) {
		this.topic = topic;
	}
	

	public com.easycms.cms.entity.assist.CmsVoteSubTopic getSubTopic() {
		return subTopic;
	}

	public void setSubTopic(com.easycms.cms.entity.assist.CmsVoteSubTopic subTopic) {
		this.subTopic = subTopic;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.easycms.cms.entity.assist.CmsVoteItem)) return false;
		else {
			com.easycms.cms.entity.assist.CmsVoteItem cmsVoteItem = (com.easycms.cms.entity.assist.CmsVoteItem) obj;
