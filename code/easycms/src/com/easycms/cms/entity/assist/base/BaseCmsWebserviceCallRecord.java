...
public abstract class BaseCmsWebserviceCallRecord  implements Serializable {
	...
	public BaseCmsWebserviceCallRecord (
		...
		com.easycms.cms.entity.assist.CmsWebserviceAuth auth,
	...
	// many to one
	private com.easycms.cms.entity.assist.CmsWebserviceAuth auth;
	 ...
	 */
	public com.easycms.cms.entity.assist.CmsWebserviceAuth getAuth () {
		return auth;
	}
	 ...
	 */
	public void setAuth (com.easycms.cms.entity.assist.CmsWebserviceAuth auth) {
		this.auth = auth;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.easycms.cms.entity.assist.CmsWebserviceCallRecord)) return false;
		else {
			com.easycms.cms.entity.assist.CmsWebserviceCallRecord cmsWebserviceCallRecord = (com.easycms.cms.entity.assist.CmsWebserviceCallRecord) obj;
