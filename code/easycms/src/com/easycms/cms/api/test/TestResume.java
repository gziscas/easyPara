...
public class TestResume {
	...
	private static String testResumeUpdate(){
		String url="http://127.0.0.1:8080/easycms/api/resume/update.jspx";
	...
	private static String testResumeGet(){
		String url="http://127.0.0.1:8080/easycms/api/resume/get.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("appId="+appId);
		String encryptSessionKey="";
		try {
	...
	private static String testApplyMyList(){
		String url="http://127.0.0.1:8080/easycms/api/resume/myapplys.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testApplyJob(){
		String url="http://127.0.0.1:8080/easycms/api/resume/apply.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testCancelApplyJob(){
		String url="http://127.0.0.1:8080/easycms/api/resume/cancelApply.jspx";
		StringBuffer paramBuff=new StringBuffer();
