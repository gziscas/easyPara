...
public class TestAccount {
	...
	private static String testDrawList(){
		String url="http://127.0.0.1:8080/easycms/api/draw/list.jspx";
	...
	private static String testDrawApply(){
		String url="http://127.0.0.1:8080/easycms/api/draw/apply.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testDrawDel(){
		String url="http://127.0.0.1:8080/easycms/api/draw/delete.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testGetAccountInfo(){
		String url="http://127.0.0.1:8080/easycms/api/account/get.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("appId="+appId);
		Map<String, String>param=new HashMap<String, String>();
		String []params=paramBuff.toString().split("&");
