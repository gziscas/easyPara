...
public class TestMessage {
	...
	private static String testMessageGet(){
		String url="http://127.0.0.1:8080/easycms/api/message/get.jspx";
	...
	private static String testMessageMyList(){
		String url="http://127.0.0.1:8080/easycms/api/message/list.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testMessageSendOrDraft(Integer box){
		String url="http://127.0.0.1:8080/easycms/api/message/send.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testMessageDraftUpdate(){
		String url="http://127.0.0.1:8080/easycms/api/message/draftUpdate.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testMessageDraftToSend(){
		String url="http://127.0.0.1:8080/easycms/api/message/draftToSend.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+2);
		paramBuff.append("&appId="+appId);
		String encryptSessionKey="";
	...
	private static String testMessageBatchOperate(String operateType,String ids){
		...
		if (operateType=="trash") {
			url="http://127.0.0.1:8080/easycms/api/message/trash.jspx";
		}else if(operateType=="revert"){
			url="http://127.0.0.1:8080/easycms/api/message/revert.jspx";
		}else{
			url="http://127.0.0.1:8080/easycms/api/message/delete.jspx";
		}
		StringBuffer paramBuff=new StringBuffer();
