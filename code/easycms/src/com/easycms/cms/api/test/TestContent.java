package com.easycms.cms.api.test;
...
import com.easycms.common.util.AES128Util;
import com.easycms.common.util.Num62;
import com.easycms.common.util.PayUtil;
import com.easycms.common.web.HttpClientUtil;
...
public class TestContent {
	...
	private static String testSaveContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/save.jspx";
	...
	private static String testUpdateContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/update.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testDelContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/del.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	private static String testRecycleContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/recycle.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testCheckContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/check.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testRejectContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/reject.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("ids="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testUpContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/up.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		paramBuff.append("&appId="+appId);
	...
	private static String testDownContent(){
		String url="http://127.0.0.1:8080/easycms/api/content/down.jspx";
		StringBuffer paramBuff=new StringBuffer();
		paramBuff.append("id="+"159");
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		//String nonce_str="ofIcgEJdPN7FoGVY";
	...
	private static String testBuyContent(){
		//购买API地址
		//String url="http://127.0.0.1:8080/easycms/api/content/buy.jspx";
		//打赏API地址
		String url="http://127.0.0.1:8080/easycms/api/content/reward.jspx";
		StringBuffer paramBuff=new StringBuffer();
	...
	public static String testUpload(String local,String type){
		String url="http://127.0.0.1:8080/easycms/api/upload/o_upload.jspx?";
	...
	private static String testUploadDoc(String local){
		String url="http://127.0.0.1:8080/easycms/api/upload/o_upload_doc.jspx?";
		FileUpload fileUpload = new FileUpload();
		String nonce_str=RandomStringUtils.random(16,Num62.N62_CHARS);
		StringBuffer paramBuff=new StringBuffer();
		Map<String, String>param=new HashMap<String, String>();
