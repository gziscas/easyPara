...
import com.easycms.cms.manager.main.ApiAccountMng;
import com.easycms.cms.manager.main.ApiRecordMng;
import com.easycms.cms.manager.main.ApiUserLoginMng;
	...
	private void initWeiXinJsCode2SessionUrl(){
		if(getWeiXinJsCode2SessionUrl()==null){
			setWeiXinJsCode2SessionUrl(PropertyUtils.getPropertyValue(
					new File(realPathResolver.get(com.easycms.cms.Constants.EASYCMS_CONFIG)),WEIXIN_JSCODE_2_SESSION_URL));
		}
	}
