package com.easycms.cms.action.admin.assist;
...
import com.easycms.cms.entity.assist.CmsAdvertisingSpace;
import com.easycms.cms.entity.assist.CmsDirectiveTpl;
import com.easycms.cms.entity.assist.CmsFriendlinkCtg;
...
import com.easycms.cms.manager.assist.CmsAdvertisingMng;
import com.easycms.cms.manager.assist.CmsAdvertisingSpaceMng;
import com.easycms.cms.manager.assist.CmsDirectiveTplMng;
import com.easycms.cms.manager.assist.CmsFriendlinkCtgMng;
	...
	public String select(String module, HttpServletRequest request, ModelMap model) {
		if(StringUtils.isNotBlank(module)){
			...
			if(module.equals(CHANNEL)||module.equals(TOPIC)){
				...
				List<CmsVoteTopic>voteList=voteTopicMng.getList(null, siteId,0, LIST_COUNT);
