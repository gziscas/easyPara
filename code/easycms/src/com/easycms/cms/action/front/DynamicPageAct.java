...
import static com.easycms.common.web.Constants.INDEX;
import static com.easycms.common.web.Constants.INDEX_HTML;
import static com.easycms.common.web.Constants.INDEX_HTML_MOBILE;
...
import com.easycms.cms.manager.assist.CmsKeywordMng;
import com.easycms.cms.manager.main.ChannelMng;
import com.easycms.cms.manager.main.ContentBuyMng;
import com.easycms.cms.manager.main.ContentMng;
import com.easycms.common.page.Paginable;
import com.easycms.common.page.SimplePage;
...
import com.easycms.core.web.util.URLHelper;
...
public class DynamicPageAct {
	...
	public String index(HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		FrontUtils.getBasePath(request);
		//设置model参数
		...
		if(existIndexPage(site)){
			...
			if (!StringUtils.isBlank(tpl)) {
				...
				tpl = FrontUtils.getTplPath(request, site.getSolutionPath(), TPLDIR_INDEX, TPL_INDEX);
				return tpl;
			}
		}
	}
	...
	private String channel(String path,boolean checkAlone, int pageNo, String[] params,
			PageInfo info, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
	...
	private String content(Integer id, int pageNo, String[] params,
			PageInfo info, HttpServletRequest request, HttpServletResponse response, ModelMap model) {
