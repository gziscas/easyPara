...
import com.easycms.common.util.WeixinPay;
import com.easycms.common.web.Constants;
...
import com.easycms.core.manager.CmsUserAccountMng;
...
import com.easycms.common.util.AliPay;
	...
	private void initAliPayUrl(){
		if(getAliPayUrl()==null){
			setAliPayUrl(PropertyUtils.getPropertyValue(
					new File(realPathResolver.get(com.easycms.cms.Constants.EASYCMS_CONFIG)),ALI_PAY_URL));
		}
	}
	...
	private void initWeiXinPayUrl(){
		if(getWeiXinPayUrl()==null){
			setWeiXinPayUrl(PropertyUtils.getPropertyValue(
					new File(realPathResolver.get(com.easycms.cms.Constants.EASYCMS_CONFIG)),WEIXIN_PAY_URL));
		}
	}
