...
public class Constants {
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="EASYCMS_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
	 ...
	 * 配置文件
	 */
	public static String EASYCMS_CONFIG = "/WEB-INF/config/easycms/easycms.properties";
	/**
	 * 插件路径
	 */
	 ...
	 * 模板路径
	 */
	public static final String TPL_BACK_BASE = "/WEB-INF/easycms_sys";
