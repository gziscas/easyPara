package com.easycms.core.web.util;

import static com.easycms.cms.Constants.RES_PATH;
import static com.easycms.cms.Constants.TPLDIR_COMMON;
import static com.easycms.cms.Constants.TPLDIR_STYLE_LIST;
import static com.easycms.cms.Constants.TPLDIR_TAG;
import static com.easycms.cms.Constants.TPL_STYLE_PAGE_CHANNEL;
import static com.easycms.cms.Constants.TPL_SUFFIX;
import static com.easycms.common.web.Constants.MESSAGE;
import static com.easycms.common.web.Constants.UTF8;
import static com.easycms.cms.Constants.BASE_PATH;
import static com.easycms.common.web.ProcessTimeFilter.START_TIME;
import static com.easycms.common.web.freemarker.DirectiveUtils.PARAM_TPL_SUB;
import static com.easycms.core.action.front.LoginAct.PROCESS_URL;
...
import com.easycms.common.web.freemarker.DirectiveUtils;
...
import com.easycms.core.web.util.URLHelper.PageInfo;
...
public class FrontUtils {
     ...
     * @return
     */
	public static String getTplPath(HttpServletRequest request, CmsSite site, String dir, String name) {
		return getTplPath(request, site.getSolutionPath(), dir, name);
	}
	...
	public static String getTplPath(MessageSource messageSource, String lang, String solution, String dir, String name) {
		...
		String tplpath = solution + "/" + dir + "/" + messageSource.getMessage(name, null, locale) + TPL_SUFFIX;
		return tplpath;
	}
