package com.easycms.core.action.front;

import static com.easycms.core.manager.AuthenticationMng.AUTH_KEY;
...
import com.easycms.core.manager.AuthenticationMng;
import com.easycms.core.web.WebCoreErrors;
...
public class LoginAct {
     ...
     * </ul>
     *
     * @param processUrl 登录成功后的处理地址。登录成功后即重定向到该页面，并将returnUrl、auth_key作为参数。
     * @param returnUrl  登录成功，并处理后，返回到该地址。
     * @param message    登录是提示的信息，比如：“您需要登录后才能继续刚才的操作”，该信息必须用UTF-8编码进行URLEncode。
     * @param request
     * @param model
