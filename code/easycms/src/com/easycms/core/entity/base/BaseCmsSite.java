...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.easycms.core.entity.CmsConfig config,
	...
	// many to one
	private com.easycms.core.entity.Ftp uploadFtp;
	private com.easycms.core.entity.Ftp syncPageFtp;
	private com.easycms.core.entity.CmsConfig config;
	// one to one
	private com.easycms.core.entity.CmsSiteCompany siteCompany;
	...
	private java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessCount> accessCounts;
	private java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccess> accesses;
	private java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessPages> accessPages;
	private java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics;
	 ...
	 */
	public com.easycms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.easycms.core.entity.Ftp uploadFtp) {
		this.uploadFtp = uploadFtp;
	}

	public com.easycms.core.entity.Ftp getSyncPageFtp() {
		return syncPageFtp;
	}

	public void setSyncPageFtp(com.easycms.core.entity.Ftp syncPageFtp) {
	 ...
	 */
	public com.easycms.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.easycms.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.easycms.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.easycms.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.easycms.core.entity.CmsUserSite> userSites) {
	...
	public java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessCount> getAccessCounts() {
		return accessCounts;
	}

	public void setAccessCounts(
			java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessCount> accessCounts) {
		this.accessCounts = accessCounts;
	}

	public java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccess> getAccesses() {
		return accesses;
	}

	public void setAccesses(
			java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccess> accesses) {
		this.accesses = accesses;
	}

	public java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessPages> getAccessPages() {
		return accessPages;
	}

	public void setAccessPages(
			java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessPages> accessPages) {
		this.accessPages = accessPages;
	}

	public java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessStatistic> getAccessStatistics() {
		return accessStatistics;
	}

	public void setAccessStatistics(
			java.util.Set<com.easycms.cms.entity.assist.CmsSiteAccessStatistic> accessStatistics) {
		this.accessStatistics = accessStatistics;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.easycms.core.entity.CmsSite)) return false;
		else {
			com.easycms.core.entity.CmsSite cmsSite = (com.easycms.core.entity.CmsSite) obj;
