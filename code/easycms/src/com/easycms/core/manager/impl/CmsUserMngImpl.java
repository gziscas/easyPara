...
import com.easycms.core.dao.CmsUserDao;
...
import com.easycms.core.manager.CmsUserSiteMng;
...
public class CmsUserMngImpl implements CmsUserMng {
	...
	public CmsUser registerMember(String username, String email,
		...
		UnifiedUser unifiedUser = unifiedUserMng.save(username, email, password, ip, true);
