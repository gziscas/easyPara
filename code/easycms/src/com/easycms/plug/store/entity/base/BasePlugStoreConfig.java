package com.easycms.plug.store.entity.base;
...
public abstract class BasePlugStoreConfig  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.easycms.plug.store.entity.PlugStoreConfig)) return false;
		else {
			com.easycms.plug.store.entity.PlugStoreConfig plugStoreConfig = (com.easycms.plug.store.entity.PlugStoreConfig) obj;
