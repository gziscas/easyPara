package com.easycms.plug.weixin.entity.base;
...
public abstract class BaseWeixinMenu  implements Serializable {
	...
	// many to one
	private com.easycms.plug.weixin.entity.WeixinMenu parent;
	private com.easycms.core.entity.CmsSite site;

	// collections
	private java.util.Set<com.easycms.plug.weixin.entity.WeixinMenu> child;
	 ...
	 */
	public com.easycms.plug.weixin.entity.WeixinMenu getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.easycms.plug.weixin.entity.WeixinMenu parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.easycms.plug.weixin.entity.WeixinMenu> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.easycms.plug.weixin.entity.WeixinMenu> child) {
		this.child = child;
	}

	public void addTochild (com.easycms.plug.weixin.entity.WeixinMenu weixinMenu) {
		if (null == getChild()) setChild(new java.util.TreeSet<com.easycms.plug.weixin.entity.WeixinMenu>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.easycms.plug.weixin.entity.WeixinMenu)) return false;
		else {
			com.easycms.plug.weixin.entity.WeixinMenu weixinMenu = (com.easycms.plug.weixin.entity.WeixinMenu) obj;
